...
# df = df.drop(df[(df.x==14)&(df.y==1)].index)
# df = df.drop(df[(df.x==2)&(df.y==4)].index)
# df = df.drop(df[(df.x==11)&(df.y==28)].index)
# df = df.drop(df[(df.x==2)&(df.y==7)].index)
# df = df.drop(df[(df.x==10)&(df.y==31)].index)
# df = df.drop(df[(df.x==5)&(df.y==29)].index)
...
# df = df.drop(df[(df.x==8)&(df.y==31)].index)
# df = df.drop(df[(df.x==12)&(df.y==7)].index)
# df = df.drop(df[(df.x==15)&(df.y==16)].index)
# df = df.drop(df[(df.x==9)&(df.y==30)].index)
# df = df.drop(df[(df.x==14)&(df.y==15)].index)
# df = df.drop(df[(df.x==11)&(df.y==27)].index)
# df = df.drop(df[(df.x==15)&(df.y==29)].index)
# df = df.drop(df[(df.x==10)&(df.y==30)].index)
# df = df.drop(df[(df.x==13)&(df.y==30)].index)
...
# df = df.drop(df[(df.x==15)&(df.y==19)].index)
# df = df.drop(df[(df.x==11)&(df.y==29)].index)
# df = df.drop(df[(df.x==7)&(df.y==25)].index)
# df = df.drop(df[(df.x==2)&(df.y==13)].index)
# df = df.drop(df[(df.x==12)&(df.y==31)].index)
# df = df.drop(df[(df.x==4)&(df.y==8)].index)
# df = df.drop(df[(df.x==11)&(df.y==31)].index)
# df = df.drop(df[(df.x==11)&(df.y==30)].index)
# df = df.drop(df[(df.x==13)&(df.y==25)].index)
# df = df.drop(df[(df.x==13)&(df.y==8)].index)
# df = df.drop(df[(df.x==5)&(df.y==26)].index)
# df = df.drop(df[(df.x==4)&(df.y==17)].index)

# df = df.drop(df[(df.x==4)&(df.y==30)].index)
# df = df.drop(df[(df.x==3)&(df.y==31)].index)
# df = df.drop(df[(df.x==7)&(df.y==31)].index)
# df = df.drop(df[(df.x==13)&(df.y==31)].index)
# df = df.drop(df[(df.x==12)&(df.y==30)].index)
# df = df.drop(df[(df.x==14)&(df.y==31)].index)
# df = df.drop(df[(df.x==15)&(df.y==28)].index)
# df = df.drop(df[(df.x==12)&(df.y==29)].index)
# df = df.drop(df[(df.x==11)&(df.y==26)].index)
# df = df.drop(df[(df.x==8)&(df.y==30)].index)
# df = df.drop(df[(df.x==4)&(df.y==29)].index)
# df = df.drop(df[(df.x==12)&(df.y==10)].index)
# df = df.drop(df[(df.x==14)&(df.y==27)].index)
# df = df.drop(df[(df.x==12)&(df.y==26)].index)
# df = df.drop(df[(df.x==9)&(df.y==31)].index)
# df = df.drop(df[(df.x==5)&(df.y==28)].index)
# df = df.drop(df[(df.x==1)&(df.y==4)].index)
# df = df.drop(df[(df.x==13)&(df.y==7)].index)
# df = df.drop(df[(df.x==9)&(df.y==25)].index)
# df = df.drop(df[(df.x==1)&(df.y==29)].index)
# df = df.drop(df[(df.x==15)&(df.y==9)].index)
# df = df.drop(df[(df.x==1)&(df.y==13)].index)
# df = df.drop(df[(df.x==5)&(df.y==25)].index)
# df = df.drop(df[(df.x==15)&(df.y==1)].index)
# df = df.drop(df[(df.x==1)&(df.y==17)].index)
# df = df.drop(df[(df.x==5)&(df.y==30)].index)
# df = df.drop(df[(df.x==6)&(df.y==28)].index)
# df = df.drop(df[(df.x==12)&(df.y==15)].index)
# df = df.drop(df[(df.x==9)&(df.y==26)].index)
# df = df.drop(df[(df.x==1)&(df.y==7)].index)
# df = df.drop(df[(df.x==13)&(df.y==29)].index)
# df = df.drop(df[(df.x==6)&(df.y==30)].index)
# df = df.drop(df[(df.x==14)&(df.y==13)].index)
# df = df.drop(df[(df.x==2)&(df.y==25)].index)
# df = df.drop(df[(df.x==1)&(df.y==8)].index)
# df = df.drop(df[(df.x==7)&(df.y==14)].index)
# df = df.drop(df[(df.x==11)&(df.y==21)].index)
# df = df.drop(df[(df.x==12)&(df.y==20)].index)
# df = df.drop(df[(df.x==14)&(df.y==20)].index)
# df = df.drop(df[(df.x==1)&(df.y==15)].index)

# df = df.drop(df[(df.x==13)&(df.y==27)].index)
# df = df.drop(df[(df.x==12)&(df.y==27)].index)
# df = df.drop(df[(df.x==7)&(df.y==23)].index)
# df = df.drop(df[(df.x==15)&(df.y==23)].index)
# df = df.drop(df[(df.x==15)&(df.y==20)].index)
# df = df.drop(df[(df.x==14)&(df.y==19)].index)
# df = df.drop(df[(df.x==14)&(df.y==14)].index)
# df = df.drop(df[(df.x==2)&(df.y==31)].index)
# df = df.drop(df[(df.x==15)&(df.y==22)].index)
# df = df.drop(df[(df.x==7)&(df.y==28)].index)
# df = df.drop(df[(df.x==11)&(df.y==2)].index)
# df = df.drop(df[(df.x==3)&(df.y==14)].index)
# df = df.drop(df[(df.x==8)&(df.y==22)].index)
# df = df.drop(df[(df.x==14)&(df.y==23)].index)
# df = df.drop(df[(df.x==13)&(df.y==20)].index)
# df = df.drop(df[(df.x==13)&(df.y==13)].index)
# df = df.drop(df[(df.x==1)&(df.y==19)].index)
# df = df.drop(df[(df.x==2)&(df.y==28)].index)
# df = df.drop(df[(df.x==1)&(df.y==23)].index)
# df = df.drop(df[(df.x==2)&(df.y==30)].index)
# df = df.drop(df[(df.x==13)&(df.y==11)].index)
# df = df.drop(df[(df.x==1)&(df.y==16)].index)
# df = df.drop(df[(df.x==13)&(df.y==1)].index)
# df = df.drop(df[(df.x==11)&(df.y==5)].index)
# df = df.drop(df[(df.x==13)&(df.y==15)].index)
# df = df.drop(df[(df.x==5)&(df.y==16)].index)
# df = df.drop(df[(df.x==5)&(df.y==14)].index)
# df = df.drop(df[(df.x==4)&(df.y==2)].index)
# df = df.drop(df[(df.x==11)&(df.y==4)].index)
# df = df.drop(df[(df.x==12)&(df.y==1)].index)
# df = df.drop(df[(df.x==2)&(df.y==9)].index)
# df = df.drop(df[(df.x==12)&(df.y==13)].index)
# df = df.drop(df[(df.x==11)&(df.y==8)].index)
# df = df.drop(df[(df.x==3)&(df.y==19)].index)
# df = df.drop(df[(df.x==4)&(df.y==27)].index)
# df = df.drop(df[(df.x==14)&(df.y==11)].index)
# df = df.drop(df[(df.x==14)&(df.y==26)].index)
# df = df.drop(df[(df.x==12)&(df.y==14)].index)
# df = df.drop(df[(df.x==4)&(df.y==16)].index)
# df = df.drop(df[(df.x==2)&(df.y==21)].index)
# df = df.drop(df[(df.x==4)&(df.y==31)].index)
# df = df.drop(df[(df.x==2)&(df.y==14)].index)
# df = df.drop(df[(df.x==13)&(df.y==28)].index)
# df = df.drop(df[(df.x==5)&(df.y==27)].index)
# df = df.drop(df[(df.x==11)&(df.y==17)].index)
# df = df.drop(df[(df.x==2)&(df.y==23)].index)
# df = df.drop(df[(df.x==2)&(df.y==15)].index)
# df = df.drop(df[(df.x==11)&(df.y==16)].index)
# df = df.drop(df[(df.x==1)&(df.y==2)].index)
# df = df.drop(df[(df.x==1)&(df.y==22)].index)
# df = df.drop(df[(df.x==8)&(df.y==26)].index)
# df = df.drop(df[(df.x==11)&(df.y==15)].index)
# df = df.drop(df[(df.x==3)&(df.y==30)].index)
# df = df.drop(df[(df.x==3)&(df.y==17)].index)
# df = df.drop(df[(df.x==12)&(df.y==28)].index)
# df = df.drop(df[(df.x==4)&(df.y==1)].index)
# df = df.drop(df[(df.x==7)&(df.y==20)].index)
# df = df.drop(df[(df.x==6)&(df.y==25)].index)
# df = df.drop(df[(df.x==12)&(df.y==16)].index)
# df = df.drop(df[(df.x==14)&(df.y==5)].index)
# df = df.drop(df[(df.x==15)&(df.y==4)].index)
# df = df.drop(df[(df.x==3)&(df.y==7)].index)
# df = df.drop(df[(df.x==7)&(df.y==1)].index)
# df = df.drop(df[(df.x==8)&(df.y==25)].index)
# df = df.drop(df[(df.x==15)&(df.y==25)].index)
# df = df.drop(df[(df.x==15)&(df.y==21)].index)
# df = df.drop(df[(df.x==14)&(df.y==4)].index)
# df = df.drop(df[(df.x==2)&(df.y==29)].index)
# df = df.drop(df[(df.x==2)&(df.y==16)].index)
# df = df.drop(df[(df.x==15)&(df.y==17)].index)
# df = df.drop(df[(df.x==8)&(df.y==23)].index)
# df = df.drop(df[(df.x==1)&(df.y==30)].index)
# df = df.drop(df[(df.x==14)&(df.y==29)].index)
# df = df.drop(df[(df.x==5)&(df.y==17)].index)
# df = df.drop(df[(df.x==2)&(df.y==27)].index)
# df = df.drop(df[(df.x==13)&(df.y==26)].index)
# df = df.drop(df[(df.x==4)&(df.y==20)].index)
# df = df.drop(df[(df.x==1)&(df.y==14)].index)
# df = df.drop(df[(df.x==15)&(df.y==30)].index)
# df = df.drop(df[(df.x==3)&(df.y==11)].index)
# df = df.drop(df[(df.x==15)&(df.y==15)].index)
# df = df.drop(df[(df.x==15)&(df.y==14)].index)
# df = df.drop(df[(df.x==4)&(df.y==23)].index)
# df = df.drop(df[(df.x==6)&(df.y==29)].index)
# df = df.drop(df[(df.x==5)&(df.y==13)].index)
# df = df.drop(df[(df.x==13)&(df.y==5)].index)
# df = df.drop(df[(df.x==5)&(df.y==11)].index)
# df = df.drop(df[(df.x==2)&(df.y==26)].index)
# df = df.drop(df[(df.x==5)&(df.y==7)].index)
...
for i in range(0,k):
        ...
        # ВРЕМЯ И ФАЗА
        # train_data = train_data.loc[:,("время 1-го луча","фаза 1-го луча","время 2-го луча","фаза 2-го луча","время 3-го луча","фаза 3-го луча","время 4-го луча","фаза 4-го луча","время 5-го луча","фаза 5-го луча","время 6-го луча","фаза 6-го луча","время 7-го луча","фаза 7-го луча","время 8-го луча","фаза 8-го луча","время 9-го луча","фаза 9-го луча","время 10-го луча","фаза 10-го луча","время 11-го луча","фаза 11-го луча","время 12-го луча","фаза 12-го луча","время 13-го луча","фаза 13-го луча","время 14-го луча","фаза 14-го луча","время 15-го луча","фаза 15-го луча")]
        # test_data = test_data.loc[:,("время 1-го луча","фаза 1-го луча","время 2-го луча","фаза 2-го луча","время 3-го луча","фаза 3-го луча","время 4-го луча","фаза 4-го луча","время 5-го луча","фаза 5-го луча","время 6-го луча","фаза 6-го луча","время 7-го луча","фаза 7-го луча","время 8-го луча","фаза 8-го луча","время 9-го луча","фаза 9-го луча","время 10-го луча","фаза 10-го луча","время 11-го луча","фаза 11-го луча","время 12-го луча","фаза 12-го луча","время 13-го луча","фаза 13-го луча","время 14-го луча","фаза 14-го луча","время 15-го луча","фаза 15-го луча")]
       
        # ВРЕМЯ И AOD
        # train_data = train_data.loc[:,("время 1-го луча","время 2-го луча","время 3-го луча","время 4-го луча","время 5-го луча","время 6-го луча","время 7-го луча","время 8-го луча","время 9-го луча","время 10-го луча","время 11-го луча","время 12-го луча","время 13-го луча","время 14-го луча","время 15-го луча","AоD phi 1-го луча", "AоD theta 1-го луча","AоD phi 2-го луча", "AоD theta 2-го луча","AоD phi 3-го луча", "AоD theta 3-го луча", "AоD phi 4-го луча", "AоD theta 4-го луча", "AоD phi 5-го луча", "AоD theta 5-го луча", "AоD phi 6-го луча", "AоD theta 6-го луча", "AоD phi 7-го луча", "AоD theta 7-го луча", "AоD phi 8-го луча", "AоD theta 8-го луча",  "AоD phi 9-го луча", "AоD theta 9-го луча", "AоD phi 10-го луча", "AоD theta 10-го луча", "AоD phi 11-го луча", "AоD theta 11-го луча", "AоD phi 12-го луча", "AоD theta 12-го луча", "AоD phi 13-го луча", "AоD theta 13-го луча", "AоD phi 13-го луча", "AоD phi 14-го луча", "AоD theta 14-го луча", "AоD phi 15-го луча", "AоD theta 15-го луча","N")]
        ...
        # ВРЕМЯ И AOA
        # train_data = train_data.loc[:,("время 1-го луча","AоA phi 1-го луча", "AоА theta 1-го луча", "время 2-го луча", "AоA phi 2-го луча", "AоА theta 2-го луча", "время 3-го луча", "AоA phi 3-го луча", "AоА theta 3-го луча", "время 4-го луча", "AоA phi 4-го луча", "AоА theta 4-го луча", "время 5-го луча", "AоA phi 5-го луча", "AоА theta 5-го луча", "время 6-го луча", "AоA phi 6-го луча", "AоА theta 6-го луча", "время 7-го луча",  "AоA phi 7-го луча", "AоА theta 7-го луча", "время 8-го луча",  "AоA phi 8-го луча", "AоА theta 8-го луча",  "время 9-го луча", "AоA phi 9-го луча", "AоА theta 9-го луча", "время 10-го луча", "AоA phi 10-го луча", "AоА theta 10-го луча", "время 11-го луча",  "AоA phi 11-го луча", "AоА theta 11-го луча", "время 12-го луча",  "AоA phi 12-го луча", "AоА theta 12-го луча", "время 13-го луча",  "AоA phi 13-го луча", "AоА theta 13-го луча", "время 14-го луча", "AоA phi 14-го луча", "AоА theta 14-го луча", "время 15-го луча", "AоA phi 15-го луча", "AоА theta 15-го луча")]
        # test_data = test_data.loc[:,("время 1-го луча","AоA phi 1-го луча", "AоА theta 1-го луча", "время 2-го луча", "AоA phi 2-го луча", "AоА theta 2-го луча", "время 3-го луча", "AоA phi 3-го луча", "AоА theta 3-го луча", "время 4-го луча", "AоA phi 4-го луча", "AоА theta 4-го луча", "время 5-го луча", "AоA phi 5-го луча", "AоА theta 5-го луча", "время 6-го луча", "AоA phi 6-го луча", "AоА theta 6-го луча", "время 7-го луча",  "AоA phi 7-го луча", "AоА theta 7-го луча", "время 8-го луча",  "AоA phi 8-го луча", "AоА theta 8-го луча",  "время 9-го луча", "AоA phi 9-го луча", "AоА theta 9-го луча", "время 10-го луча", "AоA phi 10-го луча", "AоА theta 10-го луча", "время 11-го луча",  "AоA phi 11-го луча", "AоА theta 11-го луча", "время 12-го луча",  "AоA phi 12-го луча", "AоА theta 12-го луча", "время 13-го луча",  "AоA phi 13-го луча", "AоА theta 13-го луча", "время 14-го луча", "AоA phi 14-го луча", "AоА theta 14-го луча", "время 15-го луча", "AоA phi 15-го луча", "AоА theta 15-го луча")]
        
        # все параметры
        # train_data = train_data.loc[:,("фаза 1-го луча", "мощность 1-го луча", "время 1-го луча", "AоD phi 1-го луча", "AоD theta 1-го луча", "AоA phi 1-го луча", "AоА theta 1-го луча", "фаза 2-го луча", "мощность 2-го луча", "время 2-го луча", "AоD phi 2-го луча", "AоD theta 2-го луча", "AоA phi 2-го луча", "AоА theta 2-го луча", "фаза 3-го луча", "мощность 3-го луча", "время 3-го луча", "AоD phi 3-го луча", "AоD theta 3-го луча", "AоA phi 3-го луча", "AоА theta 3-го луча", "фаза 4-го луча", "мощность 4-го луча", "время 4-го луча", "AоD phi 4-го луча", "AоD theta 4-го луча", "AоA phi 4-го луча", "AоА theta 4-го луча", "фаза 5-го луча", "мощность 5-го луча", "время 5-го луча", "AоD phi 5-го луча", "AоD theta 5-го луча", "AоA phi 5-го луча", "AоА theta 5-го луча", "фаза 6-го луча", "мощность 6-го луча", "время 6-го луча", "AоD phi 6-го луча", "AоD theta 6-го луча", "AоA phi 6-го луча", "AоА theta 6-го луча", "фаза 7-го луча", "мощность 7-го луча", "время 7-го луча", "AоD phi 7-го луча", "AоD theta 7-го луча", "AоA phi 7-го луча", "AоА theta 7-го луча", "фаза 8-го луча", "мощность 8-го луча", "время 8-го луча", "AоD phi 8-го луча", "AоD theta 8-го луча", "AоA phi 8-го луча", "AоА theta 8-го луча", "фаза 9-го луча", "мощность 9-го луча", "время 9-го луча", "AоD phi 9-го луча", "AоD theta 9-го луча", "AоA phi 9-го луча", "AоА theta 9-го луча", "фаза 10-го луча", "мощность 10-го луча", "время 10-го луча", "AоD phi 10-го луча", "AоD theta 10-го луча", "AоA phi 10-го луча", "AоА theta 10-го луча", "фаза 11-го луча", "мощность 11-го луча", "время 11-го луча", "AоD phi 11-го луча", "AоD theta 11-го луча", "AоA phi 11-го луча", "AоА theta 11-го луча", "фаза 12-го луча", "мощность 12-го луча", "время 12-го луча", "AоD phi 12-го луча", "AоD theta 12-го луча", "AоA phi 12-го луча", "AоА theta 12-го луча", "фаза 13-го луча", "мощность 13-го луча", "время 13-го луча", "AоD phi 13-го луча", "AоD theta 13-го луча", "AоA phi 13-го луча", "AоА theta 13-го луча", "фаза 14-го луча", "мощность 14-го луча", "время 14-го луча", "AоD phi 14-го луча", "AоD theta 14-го луча", "AоA phi 14-го луча", "AоА theta 14-го луча", "фаза 15-го луча", "мощность 15-го луча", "время 15-го луча", "AоD phi 15-го луча", "AоD theta 15-го луча", "AоA phi 15-го луча", "AоА theta 15-го луча")]
        # test_data = test_data.loc[:,("фаза 1-го луча", "мощность 1-го луча", "время 1-го луча", "AоD phi 1-го луча", "AоD theta 1-го луча", "AоA phi 1-го луча", "AоА theta 1-го луча", "фаза 2-го луча", "мощность 2-го луча", "время 2-го луча", "AоD phi 2-го луча", "AоD theta 2-го луча", "AоA phi 2-го луча", "AоА theta 2-го луча", "фаза 3-го луча", "мощность 3-го луча", "время 3-го луча", "AоD phi 3-го луча", "AоD theta 3-го луча", "AоA phi 3-го луча", "AоА theta 3-го луча", "фаза 4-го луча", "мощность 4-го луча", "время 4-го луча", "AоD phi 4-го луча", "AоD theta 4-го луча", "AоA phi 4-го луча", "AоА theta 4-го луча", "фаза 5-го луча", "мощность 5-го луча", "время 5-го луча", "AоD phi 5-го луча", "AоD theta 5-го луча", "AоA phi 5-го луча", "AоА theta 5-го луча", "фаза 6-го луча", "мощность 6-го луча", "время 6-го луча", "AоD phi 6-го луча", "AоD theta 6-го луча", "AоA phi 6-го луча", "AоА theta 6-го луча", "фаза 7-го луча", "мощность 7-го луча", "время 7-го луча", "AоD phi 7-го луча", "AоD theta 7-го луча", "AоA phi 7-го луча", "AоА theta 7-го луча", "фаза 8-го луча", "мощность 8-го луча", "время 8-го луча", "AоD phi 8-го луча", "AоD theta 8-го луча", "AоA phi 8-го луча", "AоА theta 8-го луча", "фаза 9-го луча", "мощность 9-го луча", "время 9-го луча", "AоD phi 9-го луча", "AоD theta 9-го луча", "AоA phi 9-го луча", "AоА theta 9-го луча", "фаза 10-го луча", "мощность 10-го луча", "время 10-го луча", "AоD phi 10-го луча", "AоD theta 10-го луча", "AоA phi 10-го луча", "AоА theta 10-го луча", "фаза 11-го луча", "мощность 11-го луча", "время 11-го луча", "AоD phi 11-го луча", "AоD theta 11-го луча", "AоA phi 11-го луча", "AоА theta 11-го луча", "фаза 12-го луча", "мощность 12-го луча", "время 12-го луча", "AоD phi 12-го луча", "AоD theta 12-го луча", "AоA phi 12-го луча", "AоА theta 12-го луча", "фаза 13-го луча", "мощность 13-го луча", "время 13-го луча", "AоD phi 13-го луча", "AоD theta 13-го луча", "AоA phi 13-го луча", "AоА theta 13-го луча", "фаза 14-го луча", "мощность 14-го луча", "время 14-го луча", "AоD phi 14-го луча", "AоD theta 14-го луча", "AоA phi 14-го луча", "AоА theta 14-го луча", "фаза 15-го луча", "мощность 15-го луча", "время 15-го луча", "AоD phi 15-го луча", "AоD theta 15-го луча", "AоA phi 15-го луча", "AоА theta 15-го луча")]
...
AV_X_MSE = round(sum(X_MSE_AV) / (k+1),3)
AV_X_MAE = round(sum(X_MAE_AV) / (k+1),3)
AV_Y_MSE = round(sum(Y_MSE_AV) / (k+1),3)
AV_Y_MAE = round(sum(Y_MAE_AV) / (k+1),3)
av_dir = round(sum(dir) / (k+1),3)
