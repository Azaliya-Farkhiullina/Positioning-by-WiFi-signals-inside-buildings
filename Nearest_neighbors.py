# -*- coding: utf-8 -*-
"""
Created on Mon Apr 11 18:46:11 2022
...
series2 = pd.Series(["X_MSE_AV","X_MAE_AV","Y_MSE_AV","Y_MAE_AV","x_test","y_test","dir"])
...
for i in range(0,373):
    ...
    # выполняем импорт и создаем объект-экземпляр класса, задавая
